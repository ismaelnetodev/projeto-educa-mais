...
import com.educamais.app.dtos.GestorCadastroDTO;
...
public class GestorService {
    ...
    public Gestor getGestor(UUID gestorId){
    ...
    public Gestor atualizaGestor(GestorCadastroDTO data, UUID gestorId){
        Optional<Gestor> gestor = gestorRepository.findById(gestorId);
    ...
    public Gestor deleteGestor(UUID id) {
